...
export const FETCH_SERVICES_FOR_CONTRACT = "FETCH_SERVICES_FOR_CONTRACT";
export const INITIALIZE_MULTI_BILLING = "INITIALIZE_MULTI_BILLING";
export const SET_BILLING_MONTHS = "SET_BILLING_MONTHS";
export const ADD_MULTI_BILLING_ENTRY = "ADD_MULTI_BILLING_ENTRY";
export const UPDATE_MULTI_BILLING_ENTRY = "UPDATE_MULTI_BILLING_ENTRY";
export const REMOVE_MULTI_BILLING_ENTRY = "REMOVE_MULTI_BILLING_ENTRY";
export const SAVE_BILLING_CONFIG_SUCCESS = "SAVE_BILLING_CONFIG_SUCCESS"; // <-- ADDED
export const SAVE_BILLING_CONFIG_FAIL = "SAVE_BILLING_CONFIG_FAIL"; // <-- ADDED
